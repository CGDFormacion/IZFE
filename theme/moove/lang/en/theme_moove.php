...
$string['frontpageintro1'] = '<span class="izfe-highlight">Gela Birtuala</span> is the online training platform designed by the Provincial Council of Gipuzkoa to support your professional work, improve your skills and competencies, and contribute to the overall goal of providing a better service to citizens.';
$string['frontpageintro2'] = 'From the Knowledge Management Section of the Public Service Department, we support you throughout your learning process and trust in your commitment and digital skills so you can make the most of the training activities in which you participate.';
$string['frontpageherotitle'] = 'Gela Birtuala';
$string['frontpageherosubtitle'] = 'Online training for Provincial Council staff';
$string['frontpagesearchlabel'] = 'Search courses';
$string['frontpagesearchplaceholder'] = 'Search courses';
$string['frontpagesearchbutton'] = 'Search';
$string['frontpageguidestitle'] = 'Guides and manuals';
$string['frontpageguidesbutton'] = 'Guides and manuals';
$string['frontpageguidesimagealt'] = 'Guides and manuals';
$string['frontpagenewstafftitle'] = 'Training for new staff';
$string['frontpagenewstaffbutton'] = 'Training for new staff';
$string['frontpagenewstaffimagealt'] = 'Training for new staff';
